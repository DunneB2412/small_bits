package com.company.algarithims.colinear;// -------------------------------------------------------------------------
/**
...
class Collinear
{
   ...
   // ----------------------------------------------------------
     ...
     *
     *  Order of growth: TODO n^3 or more procisely n1*n2*n3
     *
     *  Explanation: TODO 3 linear for loops, cycling through all combinations
     */
     ...
     *  You should adequately explain your answer. Answers without adequate explanation will not be counted.
     *
     *  Order of Growth: TODO n^2ln(n)
     *
     *  Explanation: TODO sort is n^2, 2 linear for loops holding binary search making n^2 + n^2ln(n)
     *
     *
     */
     ...
     *  You should adequately explain your answer. Answers without adequate explanation will not be counted.
     *
     *  Order of Growth: TODO lg(N)
     *
     *  Explanation: TODO each cycle in the loop halves the search space
     *
     */
