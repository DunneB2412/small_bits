...
public class encryption {
	...
	{
		assert (var>0&&var<=4 && r>=0&&r<=95):"invalid arguments for variable var or r @finction:com.company.fr_recursion.test";
		System.out.print("|| ");
		switch(var)
		{
		case 1:
	 ...
	 * @param sampleSize; the range in which the program will com.company.fr_recursion.test
	...
	public static void main(String[] args) {
		System.out.println("com.company.fr_recursion.test");
		for(int i=1;i<=4;i++)
		{
			test(42, i);
		}
