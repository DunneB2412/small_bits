package com.company.sive_of_eratosthenes;
...
public class PrimeList {
    ...
    public String toString() {
        ...
        StringBuilder out = new StringBuilder("com.company.sive_of_eratosthenes.PrimeList(elements):{");
        for(IntOI intOI:sequence){
            out.append(intOI);
            out.append(", ");
        }
    ...
    public String nonCrossedOutSubseqToString(){
        ...
        StringBuilder out = new StringBuilder("com.company.sive_of_eratosthenes.PrimeList(primes):{");
